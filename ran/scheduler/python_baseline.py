...
def roundRobinScheduling(channel_by_ue, request, active):
        weight_sum = 0.0
...
def maxThroughputScheduling(channel_by_ue, request, active):
...
def weightedScheduling(channel_by_ue, request, active):
        weight_sum = 0.0
        weights: dict[tuple[str, int], float] = {}
